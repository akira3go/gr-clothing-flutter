...
extension LinkUrlExtension on LinkUrl {
  String get urlString {
    switch (this) {
      ...
      case LinkUrl.changeUserData:
        return "https://shop.gekirock.com/mypage/change.php";
      case LinkUrl.changeDestination:
        return "https://shop.gekirock.com/mypage/delivery.php";
      case LinkUrl.withdrawal:
        return "https://shop.gekirock.com/mypage/refusal.php";
    }
  }
}
