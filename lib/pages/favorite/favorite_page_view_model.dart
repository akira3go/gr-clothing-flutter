...
final favoritePageViewModelProvider =
    StateNotifierProvider.autoDispose<FavoritePageViewModel, FavoritePageState>(
        (ref) {
  final favoriteList = [
    ClothingProduct(
        image:
        ...
        price: 8800,
        brand: "NieR（ニーア）",
        itemName: "HIGH-NECK ZIP",
        part: "OUTER【WING】"),
    ClothingProduct(
        image:
            "https://shop.gekirock.com/upload/save_image/04041435_624a839ba89a2.jpg",
        price: 12100,
        brand: "MISHIKA（ミシカ）",
        itemName: "M21100938",
        part: "OUTER【WING】"),
