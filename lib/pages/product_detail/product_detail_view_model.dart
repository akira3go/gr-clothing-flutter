...
class ProductDetailState {
  ...
  final String brandImage =
      "https://shop.gekirock.com/content/banner/assets_c/2022/04/FQnXXaYagAMebry-thumb-1200xauto-1037.jpg";
  final String part = "キーボード";
  final String productName =
      "over print（オーバープリント）over print Zinc alloy Key Holder";
  final String productCode = "Z21UD07";
  final List<String> productImages = [
    "https://shop.gekirock.com/upload/save_image/07061756_559a42d2f209e.jpg",
    "https://shop.gekirock.com/upload/save_image/07061756_559a42d2f209e.jpg",
  ];
  final String productExplain =
      "前後のレングスが大幅に異なるユニークなロングシャツ。襟足を伸ばしたような作りに加え、トロンと落ちるビッグなAラインシルエットも個性を主張する。左胸にあしらったブランドネームのステッチ、グランジ、パンクスピリットを形にしたようなスリーブレスの仕立ても絶妙の一言。また、一枚で羽織ってよし、Tシャツなどとレイヤードしてもよしと、着方次第で簡単に印象が変えられる利点にも注目を。いつものカジュアルスタイルを何段階もアップデートする主役級の万能アイテムと言えよう。\n\nこちら数量限定なのでお早めにどうぞ!";
  ...
  final String? sizeImage =
      "https://shop.gekirock.com/user_data/packages/elementary/img/common/tops.jpg?ver=202109";
  final List<List<ClothingProduct>> partBrandProductList = [
    [
      ClothingProduct(
          image:
              "https://shop.gekirock.com/upload/save_image/05021057_626f3aa10d821.jpg",
          price: 1234,
          salesPrice: 9836005,
          brand: "あああああ",
          part: "キーホルダー",
